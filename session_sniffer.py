...
class ThirdPartyServers(enum.Enum):
    ...
    PC_OMETV_OVH = (
        '15.204.0.0/16', '37.59.0.0/16', '46.105.0.0/16', '51.89.0.0/16', '54.36.0.0/14', '57.128.0.0/14', '135.125.0.0/16', '141.94.0.0/15', '146.59.0.0/16',
        '148.113.0.0/16', '162.19.0.0/16', '135.148.136.0/23', ' 135.148.150.0/23', '15.235.208.0/20',
    )
