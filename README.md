...
| NEW MONOPOLY®                            | PC                                            | Only the host is connected trough P2P                                                                                                                              |
| Payday 2                                 | PC                                            |                                                                                                                                                                    |
...
| Skate 3                                  | PS3                                           |                                                                                                                                                                    |
| Sniper Elite 3                           | PS3                                           | Only the host is connected trough P2P, and only when a player creates a match (standard servers are hosted). If you are the host, you can see everyone's IP.     |
| Sons Of The Forest                       | PC                                            | Only the host is connected trough P2P                                                                                                                              |
| TEKKEN 7                                 | PC                                            |                                                                                                                                                                    |
| The Division 2                           | PC                                            |                                                                                                                                                                    |
