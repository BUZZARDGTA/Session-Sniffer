...
| Messenger                                  | Android                                       | Sometimes the IP does not leak, or ARP spoofing drops packets. Restarting the app or initiating a call with the camera enabled can help. The IP is typically only exposed at the very beginning of the call. |
