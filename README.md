...
| Messenger                                  | Android, Microsoft Store                      | Sometimes the IP does not leak, or ARP spoofing drops packets. Restarting the app or initiating a call with the camera enabled can help.                                          |
