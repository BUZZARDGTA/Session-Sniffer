...
SETTING_METADATA: dict[str, SettingMeta] = {
    ...
    'capture_program_preset': SettingMeta(
        ...
        allowed_values=(
            'None',
            'GTA5', 'GTA4', 'RedDeadOnline',
            'Minecraft',
            'PSNPartyChat',
            'CoDMW2', 'CoDBlackOps', 'CoDMW3', 'CoDBlackOpsII', 'CoDGhosts',
            'CoDAdvancedWarfare', 'CoDBlackOpsIII', 'CoDInfiniteWarfare', 'CoDWWII',
            'CoDBlackOpsColdWar', 'CoDVanguard',
            'TheDivision2', 'GhostReconWildlands',
            'ReadyOrNot', 'Payday2',
            'EldenRing', 'EldenRingNightreign',
            'MortalKombat11', 'Tekken7', 'DragonBallFighterZ',
            'NarutoStorm4', 'Destiny', 'Skate3', 'SniperElite3', 'Monopoly2024', 'GSClient',
